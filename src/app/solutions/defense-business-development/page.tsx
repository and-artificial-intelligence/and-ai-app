...
export const metadata: Metadata = {
  title: 'Defense Business Development | Patent Litigation BD | &AI',
  description:
...
const workflowSteps = [
  {
    title: 'Opportunities',
    description: 'Personalized opportunities feed, not a generic report. Built to answer one question quickly: "Is this worth pitching?" Use a feed designed for defense-side BD triage—paired with notifications so your team can act quickly.',
    image: '/feature-2-1.png',
  },
  {
    title: 'Team matching',
    description: 'Route matters to the right partner instantly. Defense BD isn\'t just finding a case—it\'s choosing who should reach out. Opportunities supports team evaluation so one person can scan and triage, while the right partner gets the right case context.',
    image: '/feature-2-2.png',
  },
  {
    title: 'Pitch Decks',
    description: 'Complaint-to-pitch deck in one workflow. Upload a complaint, select a template, choose depth, and generate a polished pitch package—purpose-built around litigation intake.',
    image: '/3.1.png',
  },
  {
    title: 'Drafts',
    description: 'Generate the outreach materials your team actually sends. Templates and collaborative editing for pitch letters, client emails, and longer-form pitch memos—grounded in the case context.',
    image: '/3.2.png',
  },
];
...
export default function DefenseBusinessDevelopmentPage() {
  return (
    <SolutionsByUseCasePage
      ...
      faqs={[
        {
          question: 'What is "defense business development" in patent litigation?',
          answer: 'Defense business development is the workflow of identifying new patent cases worth pursuing and reaching potential defendants quickly with a credible pitch.',
        },
        {
          question: 'How is this different from PACER or generic docket alerts?',
          answer: 'PACER provides electronic public access to federal court records; docket alerts and current awareness products summarize and notify. &AI adds personalization, team matching, and complaint-to-pitch drafting to execute the outreach faster.',
        },
        {
          question: 'Is this "law firm BD automation"?',
          answer: 'Yes—Opportunities helps teams discover and triage pitch-worthy matters, and Drafts/Pitch Decks generate the outreach materials so teams can act without rebuilding the same pitch workflow every time.',
        },
        {
          question: 'Can &AI generate a pitch deck from a complaint?',
          answer: 'That\'s the complaint-to-pitch deck workflow: upload the complaint, choose a template, and generate a draft pitch package that your team can refine.',
        },
      ]}
    />
  );
